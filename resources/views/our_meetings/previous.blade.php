...
@section('content')
        ...
        <div class="container">
            ...
            <div class="block_form_three my-0">
                <div class="form_group">
                    ...
                    @else
                        <button style="text-align: center" href="#" class="alert alert-warning" onclick="window.location.href = 'https://appp-psy.ru/introduction'"
                                data-target="#confirmedAuth" data-toggle="modal">Чтобы добавить встречу нужно зарегистрироваться</button>
                    @endif
                </div>
            </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <h4>Чтобы создать встречу, вам нужно зарегистрироваться <span></span></h4>
                        </div>
                        ...
                        <div class="col-lg-4 mb-3">
                            <div class="item">
                                ...
                                <div class="block_text">
                                    ...
                                    <a href="/ourMeetings/{{$item->id}}">Подробнее</a><br>
                                    @if(Auth::check() && Auth::user()->group === 'admin')
                                        <a style="background-color: green" href="/ourMeetings/edit/{{$item->id}}">Редактировать
                                        ...
                                        @if(Auth::check() && Auth::user()->group === 'admin')
                                            <p>
                                                <button style="margin-left: 15px"
                                                        onclick="window.location.href = '/ourMeetings/delete/{{$item->id}}'"
                                                        id="delete-course" href="/courses/delete/{{$item->id}}"
    ...
    <div class="courses_block">
        <div class="container">
            <a href="{{route('ourMeetings')}}">Назад к актуальным встречам</a>
        </div>

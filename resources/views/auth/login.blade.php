...
<form action="{{ route('login') }}" method="POST" class="t-1">
    @csrf
                    ...
                    <div class="levels">
                        ...
                        @if(!empty($subscription->user_id) && $subscription->level == 0)
                           ...
                           {{-- <div id="code-input-block">
                                <form action="{{ route('confirmCode') }}" method="POST" class="t-2">
                                    @csrf
                                    <div class="title">
                        ...
                        @elseif(!empty($subscription->user_id) && $subscription->level > 0)
                            ...
                            <div id="code-input-block">
                                <form action="{{ route('login') }}" method="POST" class="t-3">
                                    @csrf
                                    <div class="title">
                                        <h3>Введите код из SMS</h3>
                                        <p>Отправлен на номер <span>{{ session('phone') }}</span></p>
        ...
        @else
            ...
            <div class="input_mask">
                ...
                <div class="form-group">
                    ...
                    <input type="email" id="mail" class="form-control" name="email" placeholder="Введите Эл. Почту"><br>
                ...
                <div class="text-center mt-3">
                    <a href="{{ route('introduction') }}">У меня еще нет аккаунта. Зарегистрироваться</a>
                </div>
            </div>
            @endsession
        </div>
